$(document).ready(function () {
    ...
    $('#add').click(function () {
        addProduct('add',1, $(this).attr('data-id'));
    });
    ...
    function initialSetValuesFromDb() {
        localStorage.setItem('sub_two_menu_id',$('#sub_two_menu_id_edit').val());
        localStorage.setItem('capri',$('#capri_edit').val());
        localStorage.setItem('agt',$('#agt_edit').val());
        localStorage.setItem('brend',$('#brend_edit').val());
        localStorage.setItem('seth',$('#seth_edit').val());
        localStorage.setItem('reng',$('#reng_edit').val());
        localStorage.setItem('en',$('#en_edit').val());
        localStorage.setItem('boy',$('#boy_edit').val());
        localStorage.setItem('qalinliq',$('#qalinliq_edit').val());
        localStorage.setItem('palet',$('#palet_edit').val());
        localStorage.setItem('center_image',$('#center_image_edit').val());
        localStorage.setItem('right_side_image_1',$('#right_side_image_1_edit').val());
        localStorage.setItem('right_side_image_2',$('#right_side_image_2_edit').val());
        localStorage.setItem('right_side_video',$('#right_side_video_edit').val());
    }
    ...
    function addProduct(id, action, product_id = 0) {
        ...
        $.ajax({
           ...
           data : {
            ...
            url : '/admin/mehsullar/product/'+product_id,
