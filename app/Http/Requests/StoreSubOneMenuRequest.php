...
class StoreSubOneMenuRequest extends FormRequest
{
    /**
    ...
    {
        $check_main_menu = MainMenu::where('main_menu_id', $request->main_menu_id)->first();
        return [
            'main_menu_id' => $check_main_menu === null ? 'required' : '',
